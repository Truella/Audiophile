...
export default function CategoryProductContainer({
	...
	return (
		<div
			className={`max-w-[1110px] flex justify-between items-center rounded-lg overflow-hidden  `}
		>
			...
			<div className=" w-[445px] h-auto">
				...
				<div className=" flex gap-4 items-center mt-12">
					...
					<button className="bg-primary hover:bg-primary-light text-white text-subtitle w-40 py-3 cursor-pointer transition-all duration-300 ease-in" onClick={()=>addToCart(product)}>
						ADD TO CART
					</button>
				</div>
			</div>
